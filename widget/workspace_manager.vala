                ...
                if (!config_window.quake_mode) {
                    try {
                        ...
                        if (work_directory != null) {
                            appinfo = GLib.AppInfo.create_from_commandline("gxde-terminal --work-directory=%s".printf(work_directory), null, GLib.AppInfoCreateFlags.NONE);
                        } else {
                            appinfo = GLib.AppInfo.create_from_commandline("gxde-terminal", null, GLib.AppInfoCreateFlags.NONE);
                        }
