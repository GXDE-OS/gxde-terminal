...
namespace Utils {
...
#else
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, (string) project_path(), "share", "gxde-terminal", "image", image_name);
#endif
    }
...
#else
        var theme_path = GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, (string) project_path(), "share", "gxde-terminal", "theme", theme_name);
#endif
...
#else
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, (string) project_path(), "share", "gxde-terminal", "theme");
#endif
    }

    public string get_additional_theme_dir() {
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, GLib.Path.get_dirname((string) get_config_dir()), "gxde-terminal", "themes");
    }
...
#else
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, (string) project_path(), "share", "gxde-terminal", file_path);
#endif
    }

    public string get_config_dir() {
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, Environment.get_user_config_dir(), "deepin", "gxde-terminal");
    }

    public string get_config_file_path(string config_name) {
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, Environment.get_user_config_dir(), "deepin", "gxde-terminal", config_name);
    }
...
#else
        return GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S,  (string) project_path(), "lib", "gxde-terminal", "ssh_login.sh");
#endif
    }
    ...
    public void show_manual() {
        try {
            ...
            deepin_manual_interface.ShowManual("gxde-terminal");
        } catch (GLib.Error e) {
            print("show_manual: %s\n", e.message);
        }
    }
    ...
    public void write_log(string log) {
        var log_file_dir = GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, Environment.get_user_cache_dir(), "deepin", "gxde-terminal");
        var log_file = GLib.Path.build_path(GLib.Path.DIR_SEPARATOR_S, Environment.get_user_cache_dir(), "deepin", "gxde-terminal", "deepin-terminal.log");
